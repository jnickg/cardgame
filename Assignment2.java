public class Assignment2
{
    ...
    public static void main(String args[])
    {
        ...
        System.out.printf("CS261 - Assignment 2 - Nick Giampietro%n%n");
        ...
        Dealer PennJillette = new Dealer("Penn Jillette");
        PennJillette.showDeck(CARDS_PER_LINE);
        PennJillette.playGames(N_GAMES, N_HANDS, CARDS_PER_HAND, SHUFFLE, CARDS_PER_LINE);
    }
}
